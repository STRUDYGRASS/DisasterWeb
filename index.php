...
// echo 'var data_info = [';
// $num_results = count($array_data);
// for($i=0; $i <$num_results; $i++) {
//     echo '[' . $array_data[$i][0]. ',' . $array_data[$i][1]. ',"' . $array_data[$i][2]. '"]' ;
//     if ($i != $num_results - 1){
//         echo ',';
//     }
// }
...
// echo 'var data_hsp = [';
// $num_results = count($array_hsp);
// for($i=0; $i <$num_results; $i++) {
//     echo '[' . $array_hsp[$i][0]. ',' . $array_hsp[$i][1]. ',"' . $array_hsp[$i][2]. '"]' ;
//     if ($i != $num_results - 1){
//         echo ',';
//     }
// }
...
//为什么不写成函数封装呢？因为这样就只运行一次了，我也不知道为什么
				...
				if(zoom<15){
                    ...
                    for (var i=0; i<data_hsp.length; i++) {
                        ...
                        if (bound.containsPoint(pt) && mAS_HSP.show){  
                            ...
                            var myIcon = new BMap.Icon("hsp.png", new BMap.Size(24,24));
